...
class TextFieldFormsEditProfileWidget extends StatelessWidget {
  final String? title;
  ...
  const TextFieldFormsEditProfileWidget(
      {Key? key,
      this.title,
      this.maxLength,
      this.controller,
      ...
      this.fontSizeHint,
      this.prefixText,
      required this.readOnly, this.fontSize})
      : super(key: key);
  @override
            ...
            decoration: InputDecoration(
                ...
                suffixIcon: Padding(
                    ...
                    child: Padding(
                        ...
                        child: SizedBox(
                            height: 10.h, width: 10.h, child: suffixIcon))))));
  }
}
